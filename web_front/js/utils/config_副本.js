...
var URL_LIST={
	...
	user_getuser:BASE_URL+'/admin/getuser',
	category_search:BASE_URL+'/admin/category_search',
	...
	article_search:BASE_URL+'/admin/search',
	...
	get_comments:BASE_URL+'/get_comments',
	post_comment:BASE_URL+'/post_comment'
